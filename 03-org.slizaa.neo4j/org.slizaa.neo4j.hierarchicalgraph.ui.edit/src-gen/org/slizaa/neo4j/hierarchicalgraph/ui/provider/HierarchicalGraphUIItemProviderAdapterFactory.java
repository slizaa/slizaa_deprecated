 ...
 * @generated
 */
public class HierarchicalGraphUIItemProviderAdapterFactory extends HierarchicalGraphUIAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable {
  /**
  ...
  public Adapter createBundleBasedMappingDescriptorAdapter() {
    if (bundleBasedMappingDescriptorItemProvider == null) {
      bundleBasedMappingDescriptorItemProvider = new BundleBasedMappingDescriptorItemProvider(this);
    }
  ...
  public Adapter createWorkspaceBasedMappingDescriptorAdapter() {
    if (workspaceBasedMappingDescriptorItemProvider == null) {
      workspaceBasedMappingDescriptorItemProvider = new WorkspaceBasedMappingDescriptorItemProvider(this);
    }
