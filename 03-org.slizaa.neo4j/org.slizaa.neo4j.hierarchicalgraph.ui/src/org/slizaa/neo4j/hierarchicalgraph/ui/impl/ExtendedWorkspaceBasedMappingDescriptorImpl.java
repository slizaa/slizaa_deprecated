...
public class ExtendedWorkspaceBasedMappingDescriptorImpl extends WorkspaceBasedMappingDescriptorImpl {
  ...
  public String resolveImage(String relativeImagePath) {
    return "platform:/resource/" + getBasePath() + "/" + relativeImagePath;
  }
}
