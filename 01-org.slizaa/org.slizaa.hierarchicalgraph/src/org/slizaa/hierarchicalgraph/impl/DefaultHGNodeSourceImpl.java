...
public class DefaultHGNodeSourceImpl extends MinimalEObjectImpl.Container implements DefaultHGNodeSource {
  ...
  public void setIdentifier(Object newIdentifier) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, HierarchicalgraphPackage.DEFAULT_HG_NODE_SOURCE__IDENTIFIER, oldIdentifier, identifier));
  }
  ...
  public HGNode getNode() {
    if (eContainerFeatureID() != HierarchicalgraphPackage.DEFAULT_HG_NODE_SOURCE__NODE) return null;
  ...
  public void setNode(HGNode newNode) {
    if (newNode != eInternalContainer() || (eContainerFeatureID() != HierarchicalgraphPackage.DEFAULT_HG_NODE_SOURCE__NODE && newNode != null)) {
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, HierarchicalgraphPackage.DEFAULT_HG_NODE_SOURCE__NODE, newNode, newNode));
  }
