...
public class HierarchicalGraphMappingDescriptorItemProvider 
   ...
   */
    ...
    if (childrenFeatures == null) {
      ...
      childrenFeatures.add(Neo4jHierarchicalGraphMappingPackage.Literals.HIERARCHICAL_GRAPH_MAPPING_DESCRIPTOR__DEPENDENCY_MAPPINGS);
   ...
   */
    ...
    newChildDescriptors.add
      (createChildParameter
        (Neo4jHierarchicalGraphMappingPackage.Literals.HIERARCHICAL_GRAPH_MAPPING_DESCRIPTOR__DEPENDENCY_MAPPINGS,
         Neo4jHierarchicalGraphMappingFactory.eINSTANCE.createDependencyMapping()));
