...
public interface Neo4jHierarchicalGraphMappingPackage extends EPackage {
  ...
  /**
   * The feature id for the '<em><b>Root Mappings</b></em>' attribute list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
  ...
  /**
   * The feature id for the '<em><b>Dependency Mappings</b></em>' containment reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int HIERARCHICAL_GRAPH_MAPPING_DESCRIPTOR__DEPENDENCY_MAPPINGS = 4;
  ...
  /**
   * The meta object id for the '{@link org.slizaa.neo4j.hierarchicalgraph.mapping.impl.DependencyMappingImpl <em>Dependency Mapping</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see org.slizaa.neo4j.hierarchicalgraph.mapping.impl.DependencyMappingImpl
   * @see org.slizaa.neo4j.hierarchicalgraph.mapping.impl.Neo4jHierarchicalGraphMappingPackageImpl#getDependencyMapping()
   * @generated
   */
  int DEPENDENCY_MAPPING = 1;

  /**
   * The feature id for the '<em><b>Main Query</b></em>' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int DEPENDENCY_MAPPING__MAIN_QUERY = 0;

  /**
   * The feature id for the '<em><b>Detail Queries</b></em>' attribute list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int DEPENDENCY_MAPPING__DETAIL_QUERIES = 1;

  /**
   * The number of structural features of the '<em>Dependency Mapping</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int DEPENDENCY_MAPPING_FEATURE_COUNT = 2;

  /**
   * The operation id for the '<em>Is Aggregated Core Dependency</em>' operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int DEPENDENCY_MAPPING___IS_AGGREGATED_CORE_DEPENDENCY = 0;

  /**
   * The number of operations of the '<em>Dependency Mapping</em>' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int DEPENDENCY_MAPPING_OPERATION_COUNT = 1;
   ...
   * @generated
   */
  int PROPERTY_BASED_IMAGE_MAPPER = 3;
  ...
  /**
   * The meta object id for the '<em>Cyper Query</em>' data type.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see java.lang.String
   * @see org.slizaa.neo4j.hierarchicalgraph.mapping.impl.Neo4jHierarchicalGraphMappingPackageImpl#getCyperQuery()
   * @generated
   */
  int CYPER_QUERY = 5;
  ...
  /**
   * Returns the meta object for the attribute list '{@link org.slizaa.neo4j.hierarchicalgraph.mapping.HierarchicalGraphMappingDescriptor#getRootMappings <em>Root Mappings</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute list '<em>Root Mappings</em>'.
   * @see org.slizaa.neo4j.hierarchicalgraph.mapping.HierarchicalGraphMappingDescriptor#getRootMappings()
   * @see #getHierarchicalGraphMappingDescriptor()
   * @generated
   */
  EAttribute getHierarchicalGraphMappingDescriptor_RootMappings();
  ...
  /**
   * Returns the meta object for the containment reference list '{@link org.slizaa.neo4j.hierarchicalgraph.mapping.HierarchicalGraphMappingDescriptor#getDependencyMappings <em>Dependency Mappings</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Dependency Mappings</em>'.
   * @see org.slizaa.neo4j.hierarchicalgraph.mapping.HierarchicalGraphMappingDescriptor#getDependencyMappings()
   * @see #getHierarchicalGraphMappingDescriptor()
   * @generated
   */
  EReference getHierarchicalGraphMappingDescriptor_DependencyMappings();
  ...
  /**
   * Returns the meta object for class '{@link org.slizaa.neo4j.hierarchicalgraph.mapping.DependencyMapping <em>Dependency Mapping</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>Dependency Mapping</em>'.
   * @see org.slizaa.neo4j.hierarchicalgraph.mapping.DependencyMapping
   * @generated
   */
  EClass getDependencyMapping();

  /**
   * Returns the meta object for the attribute '{@link org.slizaa.neo4j.hierarchicalgraph.mapping.DependencyMapping#getMainQuery <em>Main Query</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Main Query</em>'.
   * @see org.slizaa.neo4j.hierarchicalgraph.mapping.DependencyMapping#getMainQuery()
   * @see #getDependencyMapping()
   * @generated
   */
  EAttribute getDependencyMapping_MainQuery();

  /**
   * Returns the meta object for the attribute list '{@link org.slizaa.neo4j.hierarchicalgraph.mapping.DependencyMapping#getDetailQueries <em>Detail Queries</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute list '<em>Detail Queries</em>'.
   * @see org.slizaa.neo4j.hierarchicalgraph.mapping.DependencyMapping#getDetailQueries()
   * @see #getDependencyMapping()
   * @generated
   */
  EAttribute getDependencyMapping_DetailQueries();

  /**
   * Returns the meta object for the '{@link org.slizaa.neo4j.hierarchicalgraph.mapping.DependencyMapping#isAggregatedCoreDependency() <em>Is Aggregated Core Dependency</em>}' operation.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the '<em>Is Aggregated Core Dependency</em>' operation.
   * @see org.slizaa.neo4j.hierarchicalgraph.mapping.DependencyMapping#isAggregatedCoreDependency()
   * @generated
   */
  EOperation getDependencyMapping__IsAggregatedCoreDependency();
  ...
  /**
   * Returns the meta object for data type '{@link java.lang.String <em>Cyper Query</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for data type '<em>Cyper Query</em>'.
   * @see java.lang.String
   * @model instanceClass="java.lang.String"
   * @generated
   */
  EDataType getCyperQuery();
  ...
  interface Literals {
    ...
    /**
     * The meta object literal for the '<em><b>Root Mappings</b></em>' attribute list feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    EAttribute HIERARCHICAL_GRAPH_MAPPING_DESCRIPTOR__ROOT_MAPPINGS = eINSTANCE.getHierarchicalGraphMappingDescriptor_RootMappings();
    ...
    /**
     * The meta object literal for the '<em><b>Dependency Mappings</b></em>' containment reference list feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    EReference HIERARCHICAL_GRAPH_MAPPING_DESCRIPTOR__DEPENDENCY_MAPPINGS = eINSTANCE.getHierarchicalGraphMappingDescriptor_DependencyMappings();
    ...
    /**
     * The meta object literal for the '{@link org.slizaa.neo4j.hierarchicalgraph.mapping.impl.DependencyMappingImpl <em>Dependency Mapping</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see org.slizaa.neo4j.hierarchicalgraph.mapping.impl.DependencyMappingImpl
     * @see org.slizaa.neo4j.hierarchicalgraph.mapping.impl.Neo4jHierarchicalGraphMappingPackageImpl#getDependencyMapping()
     * @generated
     */
    EClass DEPENDENCY_MAPPING = eINSTANCE.getDependencyMapping();

    /**
     * The meta object literal for the '<em><b>Main Query</b></em>' attribute feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    EAttribute DEPENDENCY_MAPPING__MAIN_QUERY = eINSTANCE.getDependencyMapping_MainQuery();

    /**
     * The meta object literal for the '<em><b>Detail Queries</b></em>' attribute list feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    EAttribute DEPENDENCY_MAPPING__DETAIL_QUERIES = eINSTANCE.getDependencyMapping_DetailQueries();

    /**
     * The meta object literal for the '<em><b>Is Aggregated Core Dependency</b></em>' operation.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    EOperation DEPENDENCY_MAPPING___IS_AGGREGATED_CORE_DEPENDENCY = eINSTANCE.getDependencyMapping__IsAggregatedCoreDependency();
    ...
    /**
     * The meta object literal for the '<em>Cyper Query</em>' data type.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see java.lang.String
     * @see org.slizaa.neo4j.hierarchicalgraph.mapping.impl.Neo4jHierarchicalGraphMappingPackageImpl#getCyperQuery()
     * @generated
     */
    EDataType CYPER_QUERY = eINSTANCE.getCyperQuery();
