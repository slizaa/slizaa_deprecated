...
public class Neo4jHierarchicalGraphMappingAdapterFactory extends AdapterFactoryImpl {
   ...
   */
	protected Neo4jHierarchicalGraphMappingSwitch<Adapter> modelSwitch =
      ...
      @Override
      public Adapter caseDependencyMapping(DependencyMapping object) {
        return createDependencyMappingAdapter();
      }
      @Override
   ...
   */
	...
	/**
   * Creates a new adapter for an object of class '{@link org.slizaa.neo4j.hierarchicalgraph.mapping.DependencyMapping <em>Dependency Mapping</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createDependencyMappingAdapter() {
    return null;
  }
