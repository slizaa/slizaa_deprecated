...
public class Neo4jHierarchicalGraphMappingPackageImpl extends EPackageImpl implements Neo4jHierarchicalGraphMappingPackage {
	 ...
	 * @generated
	 */
	public EReference getHierarchicalGraphMappingDescriptor_RootMappings() {
		return (EReference)hierarchicalGraphMappingDescriptorEClass.getEStructuralFeatures().get(2);
	}
	 ...
	 * @generated
	 */
	public EAttribute getHierarchicalGraphMappingDescriptor_DependencyMappers() {
		return (EAttribute)hierarchicalGraphMappingDescriptorEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public EAttribute getCypherQuery_CypherQuery() {
		return (EAttribute)cypherQueryEClass.getEStructuralFeatures().get(0);
	}
	...
	public void createPackageContents() {
		...
		createEReference(hierarchicalGraphMappingDescriptorEClass, HIERARCHICAL_GRAPH_MAPPING_DESCRIPTOR__ROOT_MAPPINGS);
		createEAttribute(hierarchicalGraphMappingDescriptorEClass, HIERARCHICAL_GRAPH_MAPPING_DESCRIPTOR__HIERARCHY_MAPPINGS);
		createEAttribute(hierarchicalGraphMappingDescriptorEClass, HIERARCHICAL_GRAPH_MAPPING_DESCRIPTOR__DEPENDENCY_MAPPERS);
		...
		createEAttribute(cypherQueryEClass, CYPHER_QUERY__CYPHER_QUERY);
	...
	public void initializePackageContents() {
		...
		initEReference(getHierarchicalGraphMappingDescriptor_RootMappings(), this.getCypherQuery(), null, "rootMappings", null, 1, -1, HierarchicalGraphMappingDescriptor.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getHierarchicalGraphMappingDescriptor_HierarchyMappings(), ecorePackage.getEString(), "hierarchyMappings", null, 0, -1, HierarchicalGraphMappingDescriptor.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getHierarchicalGraphMappingDescriptor_DependencyMappers(), ecorePackage.getEString(), "dependencyMappers", null, 0, -1, HierarchicalGraphMappingDescriptor.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getCypherQuery_CypherQuery(), ecorePackage.getEString(), "cypherQuery", null, 1, 1, CypherQuery.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
