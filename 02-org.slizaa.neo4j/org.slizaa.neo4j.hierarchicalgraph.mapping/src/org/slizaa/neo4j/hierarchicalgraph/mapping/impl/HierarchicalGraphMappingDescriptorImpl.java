 ...
 *   <li>{@link org.slizaa.neo4j.hierarchicalgraph.mapping.impl.HierarchicalGraphMappingDescriptorImpl#getDependencyMappers <em>Dependency Mappers</em>}</li>
...
public class HierarchicalGraphMappingDescriptorImpl extends MinimalEObjectImpl.Container implements HierarchicalGraphMappingDescriptor {
	...
	/**
	 * The cached value of the '{@link #getRootMappings() <em>Root Mappings</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getRootMappings()
	 * @generated
	 * @ordered
	 */
	protected EList<CypherQuery> rootMappings;
	...
	/**
	 * The cached value of the '{@link #getDependencyMappers() <em>Dependency Mappers</em>}' attribute list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getDependencyMappers()
	 * @generated
	 * @ordered
	 */
	protected EList<String> dependencyMappers;
	 ...
	 * @generated
	 */
	public EList<CypherQuery> getRootMappings() {
		if (rootMappings == null) {
			rootMappings = new EObjectContainmentEList<CypherQuery>(CypherQuery.class, this, Neo4jHierarchicalGraphMappingPackage.HIERARCHICAL_GRAPH_MAPPING_DESCRIPTOR__ROOT_MAPPINGS);
		}
		return rootMappings;
	}
	 ...
	 * @generated
	 */
	public EList<String> getDependencyMappers() {
		if (dependencyMappers == null) {
			dependencyMappers = new EDataTypeUniqueEList<String>(String.class, this, Neo4jHierarchicalGraphMappingPackage.HIERARCHICAL_GRAPH_MAPPING_DESCRIPTOR__DEPENDENCY_MAPPERS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Neo4jHierarchicalGraphMappingPackage.HIERARCHICAL_GRAPH_MAPPING_DESCRIPTOR__ROOT_MAPPINGS:
				return ((InternalEList<?>)getRootMappings()).basicRemove(otherEnd, msgs);
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case Neo4jHierarchicalGraphMappingPackage.HIERARCHICAL_GRAPH_MAPPING_DESCRIPTOR__ROOT_MAPPINGS:
				...
				getRootMappings().addAll((Collection<? extends CypherQuery>)newValue);
				return;
			case Neo4jHierarchicalGraphMappingPackage.HIERARCHICAL_GRAPH_MAPPING_DESCRIPTOR__HIERARCHY_MAPPINGS:
				...
				return;
			case Neo4jHierarchicalGraphMappingPackage.HIERARCHICAL_GRAPH_MAPPING_DESCRIPTOR__DEPENDENCY_MAPPERS:
				getDependencyMappers().clear();
				getDependencyMappers().addAll((Collection<? extends String>)newValue);
				return;
			case Neo4jHierarchicalGraphMappingPackage.HIERARCHICAL_GRAPH_MAPPING_DESCRIPTOR__LABEL_MAPPERS:
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case Neo4jHierarchicalGraphMappingPackage.HIERARCHICAL_GRAPH_MAPPING_DESCRIPTOR__DEPENDENCY_MAPPERS:
				return dependencyMappers != null && !dependencyMappers.isEmpty();
			case Neo4jHierarchicalGraphMappingPackage.HIERARCHICAL_GRAPH_MAPPING_DESCRIPTOR__LABEL_MAPPERS:
	...
	public String toString() {
		...
		result.append(hierarchyMappings);
		result.append(", dependencyMappers: ");
		result.append(dependencyMappers);
		result.append(')');
