...
public class Neo4JBackedNodeSourceImpl extends MinimalEObjectImpl.Container implements Neo4JBackedNodeSource {
  ...
  public void setIdentifier(Object newIdentifier) {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET,
          Neo4jHierarchicalgraphPackage.NEO4_JBACKED_NODE_SOURCE__IDENTIFIER, oldIdentifier, identifier));
  }
  ...
  public HGNode getNode() {
    if (eContainerFeatureID() != Neo4jHierarchicalgraphPackage.NEO4_JBACKED_NODE_SOURCE__NODE)
      return null;
  ...
  public NotificationChain basicSetNode(HGNode newNode, NotificationChain msgs) {
    msgs = eBasicSetContainer((InternalEObject) newNode, Neo4jHierarchicalgraphPackage.NEO4_JBACKED_NODE_SOURCE__NODE,
        msgs);
    return msgs;
  }
  ...
  public void setNode(HGNode newNode) {
    if (newNode != eInternalContainer()
        || (eContainerFeatureID() != Neo4jHierarchicalgraphPackage.NEO4_JBACKED_NODE_SOURCE__NODE && newNode != null)) {
      ...
      eNotify(new ENotificationImpl(this, Notification.SET,
          Neo4jHierarchicalgraphPackage.NEO4_JBACKED_NODE_SOURCE__NODE, newNode, newNode));
  }
  ...
  public EMap<String, String> getProperties() {
    if (properties == null) {
      properties = new EcoreEMap<String, String>(HierarchicalgraphPackage.Literals.STRING_TO_STRING_MAP,
          StringToStringMapImpl.class, this, Neo4jHierarchicalgraphPackage.NEO4_JBACKED_NODE_SOURCE__PROPERTIES);
    }
    return properties;
  }
